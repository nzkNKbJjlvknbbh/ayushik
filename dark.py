...
bot = telebot.TeleBot('7924950043:AAEDDbFbND49ftOnuvVdPDD8jH7Ai3LsLZY')
...
#  Join Official Channel @DarkDdosHack
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @DarkDdosOwner."
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @DarkDdosOwner ."
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, port, and time
            ...
            if time > 120:
                response = "Error: Buy From @DarkDdosOwner For More Time"
            else:
...
Buy From :- @Bgmi_owner_420
Official Channel :- https://t.me/DarkDdosHack
'''
...
def welcome_start(message):
    ...
    response = f'''Badnam ke LODE pe aapka swagat hai, {user_name}! Sabse acche se bgmi ki maa behen yahi hack karta hai. Kharidne ke liye sampark karein.
...
3. MAKE SURE YOU JOINED https://t.me/DarkDdosHack OTHERWISE NOT WORK
